...
public class Source extends XLinkLinkable {

	private String url;
	private String name;
	private DatasetIdentifier dataset;

	public Source(DatasetIdentifier name, String url) {
		this(name.toString(), url);
		this.dataset = name;
	}

	public Source(String geomName, String url) {
		this.name = geomName;
		this.url = url;
	}
