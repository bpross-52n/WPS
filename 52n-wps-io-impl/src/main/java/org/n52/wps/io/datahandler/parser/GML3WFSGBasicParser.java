 ...
 *
 */
public class GML3WFSGBasicParser extends AbstractParser {
	
	private static Logger LOGGER = LoggerFactory.getLogger(GML3WFSGBasicParser.class);
	
	public GML3WFSGBasicParser() {
		super();
