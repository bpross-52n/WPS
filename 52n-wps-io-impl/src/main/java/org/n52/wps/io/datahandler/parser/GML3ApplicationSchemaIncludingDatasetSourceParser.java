 ...
 */
public class GML3ApplicationSchemaIncludingDatasetSourceParser extends AbstractParser {
	
	private static Logger LOGGER = LoggerFactory.getLogger(GML3ApplicationSchemaIncludingDatasetSourceParser.class);

	public GML3ApplicationSchemaIncludingDatasetSourceParser() {
		super();
