...
public class GML311BasicGenerator extends AbstractGenerator {
	
	private static Logger LOGGER = LoggerFactory.getLogger(GML311BasicGenerator.class);
		
	public GML311BasicGenerator(){
		super();
	...
	public void writeToStream(IData coll, OutputStream os) {
        ...
        if(schemaLocation==null || namespace==null){
            ...
            encoder = new org.geotools.xml.Encoder(configuration );
            encoder.setNamespaceAware(true);
            encoder.setSchemaLocation("http://www.opengis.net/gml http://schemas.opengis.net/gml/3.1.1/base/gml.xsd", namespace + " " + schemaLocation);
