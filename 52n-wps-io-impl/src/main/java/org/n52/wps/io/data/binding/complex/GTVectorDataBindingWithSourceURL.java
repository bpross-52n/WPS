...
public class GTVectorDataBindingWithSourceURL implements IComplexData{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -283900021865755135L;
	protected transient FeatureCollection<?, ?> featureCollection;	
	private String sourceURL;
	
	
	public GTVectorDataBindingWithSourceURL(FeatureCollection<?, ?> payload) {
		this.featureCollection = payload;
	}
	
	public GTVectorDataBindingWithSourceURL(FeatureCollection<?, ?> payload, String sourceURL) {
		this.featureCollection = payload;
