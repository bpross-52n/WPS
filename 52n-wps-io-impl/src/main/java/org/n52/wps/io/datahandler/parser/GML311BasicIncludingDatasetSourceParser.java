 ...
 *
 */
public class GML311BasicIncludingDatasetSourceParser extends AbstractParser {
	
	private static Logger LOGGER = LoggerFactory.getLogger(GML311BasicIncludingDatasetSourceParser.class);
	
	public GML311BasicIncludingDatasetSourceParser() {
		super();
	...
	public GTVectorDataBindingWithSourceURL parse(InputStream stream, String mimeType, String schema) {
		...
		try{
			...
			fos.flush();
			fos.close();
			GTVectorDataBindingWithSourceURL data = parseXML(tempFile);
			return data;
		}
		catch(IOException e) {
	...
	public GTVectorDataBindingWithSourceURL parse(File file, String mimeType, String schema) {
		return parseXML(file);
	}
	
	private GTVectorDataBindingWithSourceURL parseXML(File file) {
