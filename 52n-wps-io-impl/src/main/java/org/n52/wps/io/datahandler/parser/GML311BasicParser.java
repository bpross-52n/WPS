 ...
 *
 */
public class GML311BasicParser extends AbstractParser {
	
	private static Logger LOGGER = LoggerFactory.getLogger(GML311BasicParser.class);
	
	public GML311BasicParser() {
		super();
