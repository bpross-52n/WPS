...
public class OMGeneratorTest extends AbstractTestCase<OMGenerator> {
	...
	public void shouldEncodeSingleOMObservationToXML() throws IOException {
		...
		final org.n52.shetland.ogc.gml.time.TimeInstant time = new org.n52.shetland.ogc.gml.time.TimeInstant(new DateTime("2012-07-31T17:45:15.000+00:00"));
		...
		assertThat(parsedObservation.getPhenomenonTime(), is((org.n52.shetland.ogc.gml.time.Time)time));
