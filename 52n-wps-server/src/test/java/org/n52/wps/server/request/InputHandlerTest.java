...
public class InputHandlerTest extends AbstractITClass{
    ...
    public void testInputHandlerInitialization() throws ExceptionReport, XmlException, IOException {
        ...
        InputHandler instance = new InputHandler.Builder(new Input(simpleBufferAlgorithmInputArray), "org.n52.wps.server.algorithm.SimpleBufferAlgorithm", parserFactory, repositoryManager).build();
    ...
    public void testInputHandlerResolveInputInterceptors() throws ExceptionReport, XmlException, IOException {
        ...
        instance = new InputHandler.Builder(new Input(dummyTestClassAlgorithmInputArray), "org.n52.wps.server.algorithm.test.DummyTestClass", parserFactory, repositoryManager).build();
    ...
    public void testInputHandlerResolveInputDescriptionTypes() throws ExceptionReport, XmlException, IOException {
        ...
        new InputHandler.Builder(new Input(simpleBufferAlgorithmInputArray), "org.n52.wps.server.algorithm.SimpleBufferAlgorithm", parserFactory, repositoryManager).build();
        
        ProcessDescriptionType processDescriptionType = (ProcessDescriptionType) repositoryManager.getProcessDescription("org.n52.wps.server.algorithm.SimpleBufferAlgorithm").getProcessDescriptionType(WPSConfig.VERSION_100);
        ...
        new InputHandler.Builder(new Input(dummyTestClassAlgorithmInputArray), "org.n52.wps.server.algorithm.test.DummyTestClass", parserFactory, repositoryManager).build();

        processDescriptionType = (ProcessDescriptionType) repositoryManager.getProcessDescription("org.n52.wps.server.algorithm.test.DummyTestClass").getProcessDescriptionType(WPSConfig.VERSION_100);
